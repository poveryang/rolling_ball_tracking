...
# 配置项目
Write-Host "配置项目..."
cmake .. -G "Visual Studio 17 2022" -A x64 -DCMAKE_TOOLCHAIN_FILE=C:/vcpkg/scripts/buildsystems/vcpkg.cmake -DINSTALL_DIR="$projectRoot/dist/Release"
...
$exePath = "$projectRoot/dist/Release/bin/camera_control_test.exe"
